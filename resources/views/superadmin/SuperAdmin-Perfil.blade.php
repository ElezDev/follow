          ...
          <div class="p-6 bg-gray-100 rounded-lg">
              <div class="mb-6 text-center">
                  <div class="flex items-center justify-center">
                      <img id="profilePreview" src="{{ asset('img/administrador/mujer.png') }}" alt="User" class="w-40 h-40 mb-4">
                  </div>
              ...
              <form action="{{ route('superadmin.updateProfilePhoto') }}" method="POST" enctype="multipart/form-data">
                  @csrf
                  <div>
                      <label class="block text-sm font-medium text-gray-700">Cargar Foto de Perfil:</label>
                      <input type="file" name="profile_photo" accept="image/*" class="w-full p-1 mt-1 text-sm text-black bg-white rounded-md" onchange="previewImage(event)">
                  </div>

                  <div class="flex justify-end mt-6 space-x-4">
                      <button type="submit" class="px-4 py-2 text-white bg-green-700 rounded hover:bg-green-900">Actualizar Foto</button>
                      <a href="{{ route('superadmin.home') }}" class="px-4 py-2 text-gray-800 bg-gray-300 rounded hover:bg-gray-400">Cancelar</a>
                  </div>
              </form>
          </div>
      </main>
